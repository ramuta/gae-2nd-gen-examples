# Structured GAE app with ndb (Datastore wrapper library)

This is an example of a structured GAE app with the **new ndb** library (Datastore wrapper) and tests (using pytest).

## Links

- [The new ndb library repository on GitHub](https://github.com/googleapis/python-ndb)
- [The new ndb library docs](https://googleapis.dev/python/python-ndb/latest/index.html)
